...
<template>
  <!-- Embedded mode (modal) — just the table, no chrome -->
  <template v-if="props.data">
    <div v-if="displayOrders.length" class="table-wrap">
      <table class="data-table">
        ...
        <tbody>
          <tr v-for="o in displayOrders" :key="o.orderid">
  ...
  <!-- Full page mode — with header, broker select, actions, edit modal -->
  <template v-else>
    <div class="orders-page">
      ...
      <div v-else-if="!displayOrders.length" class="state-msg">No orders.</div>
            ...
            <tr v-for="o in displayOrders" :key="o.orderid">
              ...
              <td>
                <div class="actions" v-if="canAct(o)">
                  <button class="action-btn" title="Edit" @click="openEdit(o)"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></button>
                  <button class="action-btn cancel" title="Cancel" @click="cancelOrder(o)"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></button>
                </div>
              </td>
            </tr>
          </tbody>
